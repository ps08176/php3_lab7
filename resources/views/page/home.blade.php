    		...
    		<div class="row">
    			<div class="col-md-12">
					...
					@foreach($new_product as $new)
    					...
    					<div class="item">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="assets/images/{{$new->image}}" alt="Colorlib Template">
		    					...
		    					<div class="text pt-3 px-3">
		    						...
		    						<div class="d-flex">
		    							<div class="pricing">
			    							<p class="price">
											@if($new->promotion_price==0)
											<span class="mr-2 price">{{$new->price}}</span>
											@else
											<span class="mr-2 price-dc">{{$new->price}}</span><span class="price-sale">{{$new->promotion_price}}</span>
											@endif
											</p>
			    						</div>
			    						<div class="rating">
